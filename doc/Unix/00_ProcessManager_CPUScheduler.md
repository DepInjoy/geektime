...
2. [与进程有关的时间 - 易百教程]([与进程有关的时间 - 操作系统教程 (yiibai.com)](https://www.yiibai.com/os/os-various-time-related-to-the-process.html))
3. [操作系统最短作业优先(SJF)调度 - 易百教程](https://www.yiibai.com/os/os-sjf-scheduling.html)